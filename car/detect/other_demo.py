# !/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time         : 2021/9/23 9:27 下午
# @Author       : yanbingzheng@4paradigm.com
# @File         : lane_detect.py
# @Description  : 通过OpenCV实现车道线检测
...
# ref https://zhuanlan.zhihu.com/p/60891432
...
def handle_one_frame(frame):
    ...
    # cv.imwrite('./segment.jpg', segment)
    ...
    cv.imwrite('./lines.jpg', lines_visualize)
